...
public class SupplyTestContainer extends TestContainer {

    public SupplyTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/groupstp/supply/app.properties",
    ...
    public static class Common extends SupplyTestContainer {

        public static final SupplyTestContainer.Common INSTANCE = new SupplyTestContainer.Common();
