...
alter table SUPPLY_QUERY_POSITION_STAGE_DATA_ITEM add constraint FK_SUPPLY_QUERYPOSITSTAGEDATAITEM_ON_QUERY_POSITION_STAGE_DATA1 foreign key (QUERY_POSITION_STAGE_DATA_ID) references SUPPLY_QUERY_POSITION_STAGE_DATA(ID)^
...
create index IDX_SUPPLY_QUERPOSISTAGDATAITEM_ON_QUERY_POSITION_STAGE_DATA1 on SUPPLY_QUERY_POSITION_STAGE_DATA_ITEM (QUERY_POSITION_STAGE_DATA_ID)^
