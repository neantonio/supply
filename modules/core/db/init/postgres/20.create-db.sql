...
create unique index IDX_SUPPLY_QUERY_UNQ on SUPPLY_QUERY (EXT_ID) where DELETE_TS is null ^
...
create unique index IDX_SUPPLY_COMPANY_UNQ on SUPPLY_COMPANY (EXT_ID) where DELETE_TS is null ^
-- end SUPPLY_COMPANY
...
create unique index IDX_SUPPLY_STORE_UNQ on SUPPLY_STORE (EXT_ID) where DELETE_TS is null ^
...
create unique index IDX_SUPPLY_URGENCY_UNQ on SUPPLY_URGENCY (EXT_ID) where DELETE_TS is null ^
...
create unique index IDX_SUPPLY_EMPLOYEE_UNQ on SUPPLY_EMPLOYEE (EXT_ID) where DELETE_TS is null ^
...
alter table SUPPLY_QUERIES_POSITION_TOKEN_LINK_QUERIES_POSITION_LINK add constraint FK_QUEPOSTOKLINQUEPOS_ON_QUERIES_POSITION_TOKEN_LINK foreign key (QUERIES_POSITION_TOKEN_LINK_ID) references SUPPLY_QUERIES_POSITION_TOKEN_LINK(ID)^
alter table SUPPLY_QUERIES_POSITION_TOKEN_LINK_QUERIES_POSITION_LINK add constraint FK_QUEPOSTOKLINQUEPOS_ON_QUERIES_POSITION foreign key (QUERIES_POSITION_ID) references SUPPLY_QUERIES_POSITION(ID)^
