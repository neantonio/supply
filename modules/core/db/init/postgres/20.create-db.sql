...
alter table SUPPLY_SUPPLIERS_SUGGESTION add constraint FK_SUPPLY_SUPPLIERS_SUGGESTION_POS_SUP foreign key (POS_SUP_ID) references SUPPLY_POSITION_SUPPLIER(ID)^
create index IDX_SUPPLY_SUPPLIERS_SUGGESTION_POS_SUP on SUPPLY_SUPPLIERS_SUGGESTION (POS_SUP_ID)^
...
-- begin SUPPLY_VOTE
alter table SUPPLY_VOTE add constraint FK_SUPPLY_VOTE_POSITION foreign key (POSITION_ID) references SUPPLY_QUERIES_POSITION(ID)^
alter table SUPPLY_VOTE add constraint FK_SUPPLY_VOTE_EMP foreign key (EMP_ID) references SEC_USER(ID)^
alter table SUPPLY_VOTE add constraint FK_SUPPLY_VOTE_SUGGESTION foreign key (SUGGESTION_ID) references SUPPLY_SUPPLIERS_SUGGESTION(ID)^
create index IDX_SUPPLY_VOTE_POSITION on SUPPLY_VOTE (POSITION_ID)^
create index IDX_SUPPLY_VOTE_EMP on SUPPLY_VOTE (EMP_ID)^
create index IDX_SUPPLY_VOTE_SUGGESTION on SUPPLY_VOTE (SUGGESTION_ID)^
-- end SUPPLY_VOTE
